...
public class DaoIntegrationTest {
    ...
    void updateBookTest() {
        ...
        //Get byId will run in a different thread
    ...
    void testUpdateAuthor() {
        Author author = new Author();
        author.setFirstName("Toto");
        author.setLastName("Tati");

        Author saved = authorDao.saveNewAuthor(author);

        saved.setLastName("Tatas");
        Author updated = authorDao.updateAuthor(saved);

        assertThat(updated.getLastName()).isEqualTo("Tatas");
    }
